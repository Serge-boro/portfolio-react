      ...
      >
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            React Developer <br className="sm:block hidden" />
          </p>
          <p className="text-[24px]">
            Building scalable, reliable web applications for enterprise
            environments.
          </p>
          <p className="text-[20px]">
            React • TypeScript • JavaScript • REST APIs • Spring Boot
          </p>
        </div>
      </div>
