      ...
      {!isMobile ? (
        <>
          ...
          <div className="w-full flex">
            ...
            >
              Here you can find a selection of projects built with React,
              JavaScript, CSS/Sass, and HTML, including a freelance project
        ...
        <>
          <nav>
            <p className={`${styles.sectionSubText} text-[14px]`}>My work</p>
